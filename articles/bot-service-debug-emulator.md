...
Al hacer clic en el botón de inicio de sesión que muestra el bot, se le pedirá que escriba sus credenciales. Se genera un token de autenticación. Después, puede realizar las operaciones permitidas.
