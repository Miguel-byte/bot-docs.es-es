...
> [!TIP]
> En las propiedades del archivo .bot, en Visual Studio, asegúrese de que la opción **Copiar en el directorio de salida** está establecida en *Copiar siempre*.
