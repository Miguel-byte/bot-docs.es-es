...
description: Aprenda a guiar los flujos de conversación con FormFlow en Bot Framework SDK para .NET.
author: RobStand
ms.author: kamrani
manager: kamrani
ms.topic: article
