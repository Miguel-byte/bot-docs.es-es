...
- El código de este artículo se basa en el ejemplo de **NLP con LUIS**. Necesitará una copia del [ejemplo de C#](https://aka.ms/cs-luis-sample) o el [ejemplo de JS](https://aka.ms/js-luis-sample). 
