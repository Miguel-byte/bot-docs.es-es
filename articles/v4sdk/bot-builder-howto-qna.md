...
Después, se inicializa una nueva instancia de la clase `BotServices` en **BotServices.cs**, que toma la información anterior de su archivo .bot. El servicio externo se configura mediante la clase BotConfiguration.
