...
## [Implementación de bots del repositorio botbuilder-samples](bot-builder-deploy-samples.md)
# Conceptos
## [Funcionamiento de los bots](v4sdk/bot-builder-basics.md)
## [Administración de estados](v4sdk/bot-builder-concept-state.md)
## [Biblioteca de diálogos](v4sdk/bot-builder-concept-dialog.md)
...
## [Principales escenarios de bots](bot-service-scenario-overview.md)
...
### [Incorporación de botones para guiar la acción del usuario](v4sdk/bot-builder-howto-add-suggested-actions.md)
### [Guardado de los datos del usuario y la conversación](v4sdk/bot-builder-howto-v4-state.md) 
...
### [Envío de notificaciones activas a los usuarios](v4sdk/bot-builder-howto-proactive-message.md)
### [Incorporación de reconocimiento de lenguaje natural al bot](v4sdk/bot-builder-howto-v4-luis.md)
### [Respuestas a las preguntas del usuario con QnA Maker](v4sdk/bot-builder-howto-qna.md)
...
#### [Implementación de un flujo de conversación secuencial](v4sdk/bot-builder-dialog-manage-conversation-flow.md)
#### [Recopilación de datos de entrada del usuario mediante un aviso de diálogo](v4sdk/bot-builder-prompts.md)
#### [Creación de un flujo de conversación avanzado con ramas y bucles](v4sdk/bot-builder-dialog-manage-complex-conversation-flow.md)
...
#### [Reutilización de diálogos](v4sdk/bot-builder-compositcontrol.md)
